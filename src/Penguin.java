...
public class Penguin extends Animal implements Walk, Swim{
    ...
    /** TODO 9(b): Create the setters and getters of the properties. **/
    ...
    /** TODO 9(b) End **/
     ...
     /** TODO 9(c): Ensure that when the default constructor of the Penguin is called,
    ...
    /** TODO 9(d): Override the eatingFood() method and implement the method
    ...
    /** TODO 9(e): Implement both the Walk and the Swim interfaces **/
